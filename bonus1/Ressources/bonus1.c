...
//Nous avone une vulnerabilite de conversion de signe, Type Demotion/Narrowing ou de int min (je pense plus a une conversion de signe par rapport au bit de signe), comme indiquer sur cette page:
