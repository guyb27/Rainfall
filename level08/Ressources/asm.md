...
```assembly
   ...
   0x0804856c <+8>:     sub    esp,0xa0                  # alloc 160 bytes
   ...
   0x080485ae <+74>:    call   0x8048440 <fgets@plt>     # fgets(char[128], 128, stdin)
   ...
   0x080485cf <+107>:   repz cmps BYTE PTR ds:[esi],BYTE PTR es:[edi] # strncmp(char 128, "auth ", 5)
   ...
   0x080485e2 <+126>:   jne    0x8048642 <main+222>   # jmp if strncmp != 0
   0x080485e4 <+128>:   mov    DWORD PTR [esp],0x4
   0x080485eb <+135>:   call   0x8048470 <malloc@plt> # malloc 4
   0x080485f0 <+140>:   mov    ds:0x8049aac,eax       # to <auth>
   0x080485f5 <+145>:   mov    eax,ds:0x8049aac
   0x080485fa <+150>:   mov    DWORD PTR [eax],0x0    # set 0 to <auth>
   ...
   0x0804861c <+184>:   repnz scas al,BYTE PTR es:[edi] # strlen(char[128])
   0x0804861e <+186>:   mov    eax,ecx
   0x08048620 <+188>:   not    eax
   0x08048622 <+190>:   sub    eax,0x1
   0x08048625 <+193>:   cmp    eax,0x1e               
   0x08048628 <+196>:   ja     0x8048642 <main+222>   # jmp if strlen > 30
   ...
   0x0804863d <+217>:   call   0x8048460 <strcpy@plt> # strcpy(<auth>, char[128]+5)
   ...
   0x08048656 <+242>:   repz cmps BYTE PTR ds:[esi],BYTE PTR es:[edi] # strncmp(char 128, "reset", 5)
   ...
   0x08048669 <+261>:   jne    0x8048678 <main+276>   # jmp if strncmp(char[128], "reset, 5) != 0
   ...
   0x0804869f <+315>:   jne    0x80486b5 <main+337>   # jmp if strncmp(char[128], "service", 6) != 0
   0x080486a1 <+317>:   lea    eax,[esp+0x20]
   0x080486a5 <+321>:   add    eax,0x7
   0x080486a8 <+324>:   mov    DWORD PTR [esp],eax
   0x080486ab <+327>:   call   0x8048430 <strdup@plt> # strdup(char[128]+7)
   ...
   0x080486dc <+376>:   jne    0x8048574 <main+16>    # jmp if strncmp(char[128], "login", 5) != 0
   0x080486e2 <+382>:   mov    eax,ds:0x8049aac
   0x080486e7 <+387>:   mov    eax,DWORD PTR [eax+0x20]
   0x080486ea <+390>:   test   eax,eax
   0x080486ec <+392>:   je     0x80486ff <main+411>   # jmp if !auth+32
   ...
   0x08048722 <+446>:   call   0x8048450 <fwrite@plt> # puts("Password:");
