...
```assembly
   ...
   0x080484fc <+8>:     sub    esp,0xa0                 # alloc 160 bytes
   ...
   0x0804856f <+123>:   call   0x80483d0 <fread@plt>    # fread(buf[136], 1, 66, file)
   0x08048574 <+128>:   mov    BYTE PTR [esp+0x59],0x0  # buf[65] = 0
   ...
   0x08048589 <+149>:   mov    BYTE PTR [esp+eax*1+0x18],0x0 # buf[atoi]
   ...
   0x080485b3 <+191>:   call   0x80483d0 <fread@plt>    # fread(buf[136]+66, 1, 65, file)
   ...
   0x080485e1 <+237>:   jne    0x8048601 <main+269>     # jmp if strcmp(buf[136], argv[1]) != 0
   ...
   0x0804860b <+279>:   call   0x80483e0 <puts@plt>     # puts(buf[136]+66)
